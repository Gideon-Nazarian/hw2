...
{
  Product* tempClothing = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
...
{
  Product* tempMovie = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
